...
{
    [SerializeField] private ETargetRelation desiredRelation;
    ...
    public override bool CheckRestriction(UnitController unit)
    {
        ...
        return TargetHelper.TargetRelation(unit.Team, hit.gameObject.GetComponent<TeamController>(), desiredRelation);
    }
}