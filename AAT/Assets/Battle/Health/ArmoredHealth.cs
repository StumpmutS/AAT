...
public class ArmoredHealth : Health, IArmor
{
    ...
    private float _baseArmorPercent => stats.GetModifiedStat(EUnitFloatStats.BaseArmorPercent);
    private float _maxArmorPercent => stats.GetModifiedStat(EUnitFloatStats.MaxArmorPercent);
