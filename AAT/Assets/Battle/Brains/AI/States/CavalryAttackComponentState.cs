...
public class CavalryAttackComponentState : AttackComponentState
{
    ...
    protected float _chaseSpeedPercent => Stats.GetStat(EUnitFloatStats.ChaseSpeedPercentMultiplier);
    protected float _moveSpeed => Stats.GetStat(EUnitFloatStats.MovementSpeed);
