...
public class SpawnerManager : NetworkBehaviour
{
    ...
    public Dictionary<SpawnerController, Tuple<SpawnerUnitManager, SpawnerVisualsController>> Spawners { get; private set; } = new();
    ...
    public void AddSpawner(SpawnerController spawner)
    {
    ...
    public void RemoveSpawner(SpawnerController spawner)
    {
    ...
    private void HandleSelected(SpawnerController spawner)
    {
        _selectedSpawnerUnitManagers.Add(Spawners[spawner].Item1);
    }

    private void HandleDeselected(SpawnerController spawner)
    {
