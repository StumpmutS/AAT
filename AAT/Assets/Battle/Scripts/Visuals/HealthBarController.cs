...
public class HealthBarController : MonoBehaviour
{
    ...
    [SerializeField] private OutlineSelectableController selectable;
    [SerializeField] private NetworkStateComponentContainer networkContainer;
    ...
    private void SetSpring(GameObject _, float u)
    {
        spring.SetTarget(1);
    }
