...
public class FusionStatsObjectIds : Fusion.Behaviour, IFusionStatsView {
  ...
  static Color _noneAuthColor  = new(0.2f, 0.2f, 0.2f, 0.9f);
  static Color _inputAuthColor = new(0.1f, 0.6f, 0.1f, 1.0f);
  static Color _stateAuthColor = new(0.8f, 0.4f, 0.0f, 1.0f);
